// NOTE: generated by `shadcn add button`, with ONE deliberate deviation:
// every `rounded-*` is `rounded-full`. The Streamlit prototype sets
// `buttonRadius = "full"` in .streamlit/config.toml and MIGRATION.md §4.4
// carries that over. Re-apply this after regenerating the component.
